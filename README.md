...
1. Build the self-extracting installer:
   ...
   This produces `bme280mon-v0.1.0-linux-arm64.install` — a single executable shell script with the `bme280mon` binary, the systemd unit, and the example config bundled inside it.
